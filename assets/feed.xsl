        ...
        <html lang="en">
            ...
            <body>
                ...
                <main id="main" tabindex="-1">
                    <h1>RSS</h1>
                    <p class="index-intro big">This is an old-school RSS feed. Copy the URL in your browser and paste it into your feed reader and you’re set. Or click on a link to read my latest updates. </p>
                    <ul class="index-list">
